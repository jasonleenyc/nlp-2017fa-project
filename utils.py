...
class Best:
    ...
    def accumulate(self, *other_values):
        ...
        with torch.cuda.device(self.gpu):
            ...
            if self.best_cmp_value is None or self.cmp_fn(self.best_cmp_value, *cmp_values) != self.best_cmp_value:
...
def data_path():
    if "vine" in os.uname()[1] \
       ...
       or "lion" in os.uname()[1]:
        return "/misc/kcgscratch1/ChoGroup/jasonlee/IWSLT/en-de/"

    elif "log-" in os.uname()[1]:
        return "/scratch/yl1363/IWSLT/en-de/"
